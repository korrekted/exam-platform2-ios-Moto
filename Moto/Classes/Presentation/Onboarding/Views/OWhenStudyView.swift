...
final class OWhenStudyView: OSlideView {
    ...
    lazy var cell1 = makeCell(title: "Onboarding.WhenStudy.Cell1", tag: 0)
    lazy var cell2 = makeCell(title: "Onboarding.WhenStudy.Cell2", tag: 1)
    lazy var cell3 = makeCell(title: "Onboarding.WhenStudy.Cell3", tag: 2)
    lazy var cell4 = makeCell(title: "Onboarding.WhenStudy.Cell4", tag: 3)
...
private extension OWhenStudyView {
    func makeConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            cell3.bottomAnchor.constraint(equalTo: cell4.topAnchor, constant: -12.scale)
        ])
