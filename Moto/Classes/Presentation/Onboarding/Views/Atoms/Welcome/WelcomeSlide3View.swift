...
private extension WelcomeSlide3View {
    func makeConstraints() {
        NSLayoutConstraint.activate([
            ...
            imageView.widthAnchor.constraint(equalToConstant: ScreenSize.isIphoneXFamily ? 344.scale : 325.scale),
            imageView.heightAnchor.constraint(equalToConstant: ScreenSize.isIphoneXFamily ? 266.scale : 220.scale),
